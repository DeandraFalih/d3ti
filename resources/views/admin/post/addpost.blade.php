								...
								<section class="panel">
									...
									<div class="form-group">
												...
												<div class="col-md-9">
													<select name="category" class="col-md-12">
									                  @foreach ($data_post_categories as $data)
									                    <option value="{{ $data->post_categories_name }}">{{ $data->post_categories_name }}</option>
									                  @endforeach
													</select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<textarea name="excerpt" class="col-md-12" maxlength="120" style="height: 150px;"></textarea>
												</div>
											</div>
