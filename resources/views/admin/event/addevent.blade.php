...
@section('content')
<head>
	<title>D3 Teknik Informatika - Add Event</title>
...
<section role="main" class="content-body">
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			...
			<form method="post" novalidate="novalidate" action="{{ url('/d3ti-admin/add_event/process') }}" enctype="multipart/form-data" class="form-horizontal form-bordered">
				@csrf
								...
								<section class="panel">
									...
									<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="file" name="featured" accept="image/png, image/jpg, image/jpeg">
												</div>
											</div>
											...
											<div class="form-group" style="margin-top: 50px;">
												...
												<div class="col-md-9">
													<input type="datetime-local" name="date_of_event" class="col-md-12">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<textarea name="excerpt" class="col-md-12" style="height: 150px;"></textarea>
												</div>
											</div>
